...
namespace EGamePlay.Combat
{
	...
	using Sirenix.Utilities.Editor; using Sirenix.Utilities;
    ...
    public class CombatAttributeWindow : OdinEditorWindow
	{
        ...
        {
            base.OnEnable();
			attributeConfigObject = AssetDatabase.LoadAssetAtPath<AttributeConfigObject>("Assets/EGamePlay-Examples/RpgExample/Resources/??????.asset");
    ...
    //            }
		...
		//[OnInspectorGUI(PrependMethodName ="DrawStateList", AppendMethodName = "EndDrawStateMatrix")]
		//[HideLabel]
		//[TableMatrix(/*HorizontalTitle = "?????",*/ DrawElementMethod = "DrawColoredEnumElement", ResizableColumns = true, /*RowHeight = 16,*/ HideColumnIndices =true, HideRowIndices =true)]
        ...
        //[MenuItem("Tools/EGamePlay/????????")]
        private static void ShowWindow()
		{
			var window = GetWindowWithRect<CombatAttributeWindow>(new Rect(0, 0, 800, 600), true, "????????");
            window.position = Sirenix.Utilities.GUIHelper.GetEditorWindowRect().AlignCenter(700, 700);
		}
